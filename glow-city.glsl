// This Ghostty shader is a port of https://www.shadertoy.com/view/XlsyWB
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    float alpha = step(length(terminalColor.rgb), 0.8);
    vec3 blendedColor = mix(terminalColor.rgb * 1.0, color.rgb * 0.3, alpha);
